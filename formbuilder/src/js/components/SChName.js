...
class SChName extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  defineValidation() {
    var validation = [{
      "type":"checkEmpty",
      "enValidMsg":"Please enter the Chinese name",
      "chValidMsg":"請輸入中文名稱"
    },
    {
      "type":"checkChName",
      "enValidMsg":"Please enter a valid Chinese name",
      "chValidMsg":"請輸入正確的中文名稱"
    }]
